...
def inspect(route):
  ...
  # controlsd consumes the latest longitudinalPlan decision; interpolation would invent a target
  # between planner publications and hide a real longcontrol state-machine override.
  plan = hold_last(t_cc, t_lp, plan_accel)
