...
def _build(route):
  ...
  # aTarget is a published decision consumed through SubMaster, not a continuous trajectory to
  # interpolate. Linear interpolation invents planner values between messages and can conceal the
